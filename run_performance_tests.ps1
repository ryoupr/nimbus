# Performance Test Runner for Nimbus v3.0 (Windows)
...
Write-Host "🚀 Nimbus v3.0 - Performance Test Suite (Windows)" -ForegroundColor Cyan
...
if (-not (Test-Path "Cargo.toml")) {
    Write-Error "Please run this script from the nimbus-rust directory"
    exit 1
}
...
---
*Generated by Nimbus Performance Test Suite (Windows)*
"@
